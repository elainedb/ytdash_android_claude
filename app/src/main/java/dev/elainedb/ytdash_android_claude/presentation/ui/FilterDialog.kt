    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                Text("Channel", style = MaterialTheme.typography.titleSmall, modifier = Modifier.padding(bottom = 8.dp))
                ...
                Text("Country", style = MaterialTheme.typography.titleSmall, modifier = Modifier.padding(top = 16.dp, bottom = 8.dp))
