package dev.elainedb.ytdash_android_claude.presentation.login
...
import dev.elainedb.ytdash_android_claude.MainActivity
import dev.elainedb.ytdash_android_claude.R
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signInButton.setOnClickListener {
            errorText.text = ""
            val signInIntent = signInWithGoogle.getSignInIntent()
