package dev.elainedb.ytdash_android_claude.video.data.local
...
interface VideoDao {
    ...
    @Query("""
        ...
        ORDER BY
            CASE WHEN :sortBy = 'publishedAt_desc' THEN publishedAt END DESC,
            CASE WHEN :sortBy = 'publishedAt_asc' THEN publishedAt END ASC,
            CASE WHEN :sortBy = 'recordingDate_desc' THEN recordingDate END DESC,
            CASE WHEN :sortBy = 'recordingDate_asc' THEN recordingDate END ASC
    """)
